...
export const ERROR_HINTS = {
  "user-not-found": {
    hint: "Make sure the user has installed the MIEWeb Auth app and completed registration.",
  },
  "no-devices": {
    hint: "Make sure the user has installed the MIEWeb Auth app and completed registration.",
  },
  ...
  "device-not-approved": {
    type: "warning",
    hint: "An admin needs to approve the device before notifications can be sent.",
  },
  "api-key-required": {
    type: "warning",
    hint: "Check your API key in the fields below, or contact your administrator.",
  },
  "api-key-invalid": {
    type: "warning",
    hint: "Check your API key in the fields below, or contact your administrator.",
  ...
  "fcm-error": {
    hint: "The push notification service encountered an issue. Ask the user to re-open the app to refresh their device token.",
  },
  timeout: {
    type: "warning",
    hint: "The user did not respond in time. They may not have seen the notification — try again.",
  },
  "network-error": {
    hint: "If the problem persists, the server may be down for maintenance.",
  },
};
