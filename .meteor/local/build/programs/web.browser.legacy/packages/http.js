...
var require = meteorInstall({"node_modules":{"meteor":{"http":{"httpcall_client.js":function module(require,exports){
...
HTTP.call = function (method, url, options, callback) {
  ...
  try {
    ...
    for (var k in meteorBabelHelpers.sanitizeForInObject(headers)) xhr.setRequestHeader(k, headers[k]);
...
return {
  ...
  require: require,
  eagerModulePaths: [
    "/node_modules/meteor/http/httpcall_client.js"
  ],
  mainModulePath: "/node_modules/meteor/http/httpcall_client.js"
}});
