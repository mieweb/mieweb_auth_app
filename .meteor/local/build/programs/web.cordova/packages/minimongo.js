...
module.export({
  ...
  CLIENT_ONLY_METHODS: function () {
    return CLIENT_ONLY_METHODS;
  }
});
function getAsyncMethodName(method) {
  return method.replace('_', '') + "Async";
}
var ASYNC_COLLECTION_METHODS = ['_createCappedCollection', 'dropCollection', 'dropIndex',
/**
 ...
 */
'map'];
var CLIENT_ONLY_METHODS = ["findOne", "insert", "remove", "update", "upsert"];
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
