        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.div variants={fadeUp} custom={2} className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={buttonVariants({ size: 'lg' }) + ' bg-gray-900 hover:bg-gray-800 text-white font-semibold no-underline'}
            >
            ...
            <a
              ...
              className={buttonVariants({ size: 'lg', variant: 'outline' }) + ' font-semibold no-underline'}
            >
              <span className="shrink-0"><Bell className="w-5 h-5" /></span>
