          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Test your Auth app, a professional two-factor authentication app
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex gap-2 shrink-0">
                      ...
                      <a
                        ...
                        className="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-white bg-black hover:bg-gray-800 shadow-sm transition-colors"
                      >
                        <svg
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Enter the username of the registered device you want to
                      test.
                    </p>
                  </div>
                    ...
                    <div className="flex items-start mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-700 mt-1">
                          If API Authentication is enabled, you must provide an
                          API key.
                        </p>
                      </div>
                    </div>
